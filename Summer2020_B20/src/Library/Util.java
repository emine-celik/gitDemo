...
public class Util {
    ...
    // retuns the uniques from the String
    ...
    /// return s the frequency of every single characters from a String
    ...
    // find aand return the max number from in array
    ...
    //find aand return the min number from in array
    ...
    // sorts Integer array in desendin order
    ...
    // sorts Double array in desendin order
    ...
    public static Character[]  sortDesc(Character[] arr){
        ...
        return arr2;
         ...
         // sorts Character array in desendin order
